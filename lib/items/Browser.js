...
const browser = [
  ...
  },
  {
    ...
    windowClasses: ['navigator', 'firefox.exe', 'firefox',
      'firefoxdeveloperedition', 'firefox developer edition', 'firefox-esr'],
  },
  {
    title: 'Vivaldi',
  ...
  },
  {
    ...
    os: ['linux', 'macos', 'windows'],
    windowClasses: ['opera', 'opera.exe', 'opera beta', 'opera developer'],
  },
  {
    title: 'Brave Browser',
  ...
  },
  {
    ...
    windowClasses: ['msedge.exe', 'microsoft edge', 'microsoft-edge-dev'],
  },
  {
  ...
  },
  {
    ...
    os: ['linux', 'macos', 'windows'],
    windowNames: [
      {endsWith: 'free download manager'},
    ],
  ...
  },
  {
    ...
    os: ['linux', 'macos', 'windows'],
    windowClasses: ['biscuit.exe', 'biscuit'],
  },
  {
    title: 'Tabs Outliner',
    windowNames: [
      {endsWith: 'tabs outliner'},
    ],
  },
];
