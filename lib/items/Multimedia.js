...
const items = [
  ...
  },
  {
    ...
    os: ['windows'],
    windowClasses: ['potplayermini64.exe'],
  },
  {
    title: 'VEGAS PRO',
  ...
  },
  {
    ...
    os: ['windows'],
    windowClasses: ['voidol.exe'],
  },
  {
    title: 'FL Studio',
    url: 'https://www.image-line.com/flstudio',
    os: ['windows'],
    windowClasses: ['fl64.exe'],
  },
  {
    title: 'Audacity',
    url: 'https://www.audacityteam.org',
    os: ['windows', 'macos', 'linux'],
    windowClasses: ['audacity', 'audacity.exe'],
  },
  {
    title: 'Vokoscreen',
    url: 'https://linuxecke.volkoh.de/vokoscreen/vokoscreen.html',
    os: ['linux'],
    windowClasses: ['vokoscreen'],
  },
  {
    title: 'Clementine',
    windowClasses: ['clementine'],
  },
];
