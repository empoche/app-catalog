...
const items = [
  {
    title: 'Calculator',
    windowClasses: ['calculator', 'win32calc.exe'],
  },
  {
    title: 'Pages',
    windowClasses: ['pages'],
  ...
  },
  {
    ...
    windowClasses: ['et', 'wps', 'wps office', 'wpsoffice', 'wpp.exe', 'wps.exe'],
  },
  {
    title: 'Calculator',
    windowNames: [
  ...
  {
    title: 'PowerWord',
    url: 'http://www.ksoffice.net/products/kingsoft-powerword-2010.htm',
    windowClasses: ['powerword.exe'],
  },
  {
    title: 'BusyContacts',
    url: 'https://www.busymac.com/busycontacts',
    windowClasses: ['busycontacts'],
  },
  {
    title: 'uTools',
    url: 'https://u.tools',
    windowClasses: ['utools.exe'],
  },
  {
    title: 'Visio',
    windowClasses: ['visio.exe'],
  },
];
