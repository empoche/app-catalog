...
const items = [
  ...
  {
    title: 'Ulysses',
    description: 'DescriptionUlysses is a text editor for Apple Mac OS X, iPad, and iPhone. It is targeted at creative writers who do not want to worry about text layout, formatting..',
    os: ['macos'],
